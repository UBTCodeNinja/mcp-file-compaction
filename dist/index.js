...
import { readFile, peekFile, editFile, writeFile, fileStatus, forgetFile, } from './tools.js';
        ...
        switch (name) {
            ...
            case 'edit_file': {
                ...
                if (!path || oldString === undefined || newString === undefined) {
                    throw new McpError(ErrorCode.InvalidParams, 'path, old_string, and new_string are required');
                }
